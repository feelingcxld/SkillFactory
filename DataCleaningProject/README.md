...
* [data_cleaning.ipynb](./data_cleaning.ipynb) - jupyter-ноутбук, содержащий основной код проекта, в котором демонстрируются методы и подходы решения задач очистки данных
...
В данном проекте была проделана большая работа по очистке данных. 

Мы рассмотрели методы работы с пропущенными данными, в которые входят:
* Удаление признаков с большим количеством пропущенных данных
* Удаление строк с большим количеством пустых признаков
* Заполнение пустых значений константами

Также в данном проекте мы научились работать с выбросами и находить их при помощи следующих методологий:
* Метод межквартильного размаха
* Метод z-отклонений

В конце мы также рассмотрели как находить и избавляться от дубликатов в данных.
